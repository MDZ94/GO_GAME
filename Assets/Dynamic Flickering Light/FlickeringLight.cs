...
public class FlickeringLight : MonoBehaviour {
    ...
    private void Position()
    {
        ...
        if (setNewTargets)
        {
            positionDelta = (positionOrigin + new Vector3(Random.Range(-1f, 1f), Random.Range(-0.1f, 0.1f), Random.Range(-1f, 1f)).normalized * positionOffset - transform.position) * speed;
